        ...
        for qid, question in questions_dict.items():
            ...
            for i in range(3):
                ...
                with open(os.path.join(save_path, f"{result_filename}.txt"),'a') as f:
                    ...
                    prediction, _ = reasoning((args.operator, args.temperature, args.top_p), args.supervisor, question, args.iter_limit, prompt, sub_prompt, entities, f, info=info, dataset='WebQSP', budget=args.budget, ablation=args.ablation, c4_ranker=args.c4_ranker, c4_weights=args.c4_weights, c4_log_path=args.c4_log_path, c5_search=args.c5_search, c5_max_iterations=args.c5_max_iterations, c5_k0=args.c5_k0, c5_k_min=args.c5_k_min, c5_k_max=args.c5_k_max, c5_sim_depth=args.c5_sim_depth, c5_strategy=args.c5_strategy, gold_answers=label, c5_ablation=args.c5_ablation)
